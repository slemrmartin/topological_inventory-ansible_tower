...
COMPONENT_NAME="topological-inventory-ansible-tower"  # name of app-sre "resourceTemplate" in deploy.yaml for this component
IMAGE="quay.io/cloudservices/topological-inventory-ansible-tower"
